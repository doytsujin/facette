                ...
                <template slot-scope="item">
                    <v-list-tile :grow="true">
                        <div class="name">
                            ...
                            <v-icon class="state-error" icon="exclamation-circle"
                                v-tooltip.bottom="item.value.error"
                                v-if="type == 'providers' && item.value.error"></v-icon>
                            <v-icon class="state-enabled" icon="check-circle"
                                v-tooltip.bottom="$t('mesg.providers.enabled')"
                                v-else-if="type == 'providers' && item.value.enabled"></v-icon>
        ...
        <v-sidepane ref="sidepane" v-model="side.open" v-if="section == 'catalog'">
            ...
            <template v-else>
                ...
                <dl>
                    ...
                    <dd :key="origin" v-for="origin in side.data.origins">{{ origin }}</dd>
                    <dt v-if="side.data.sources">{{ $t("label.sources._") }}</dt>
                    <dd :key="source" v-for="source in side.data.sources">{{ source }}</dd>
                    <dt v-if="side.data.providers">{{ $t("label.providers._") }}</dt>
                    <dd :key="provider" v-for="provider in side.data.providers">{{ provider }}</dd>
                </dl>
            </template>
